...
export const ICDownOutlined = () => { return <DownOutlined color="#773275" rev={undefined} /> };
export const ICZoomInOutlined = () => { return <ZoomInOutlined color="#773275" rev={undefined} /> };
